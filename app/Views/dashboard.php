    ...
    <div class="container mt-5" style="min-height: calc(100vh - 150px);">
        ...
        <div class="row mt-5 justify-content-center">
            ...
            <div class="col-md-3 text-center">
                <div class="card">
                    <div class="card-body">
                        <i class="fas fa-box-open fa-3x mb-3"></i> <!-- Ícono para Ingresos de mercancía -->
                        <h5 class="card-title">INGRESOS</h5>
                        <p class="card-text">Ingresos de picos.</p>
                        <a href="#" class="btn btn-primary">Ir a Ingresos</a>
                    </div>
                </div>
            </div>
            <!-- Card Egresos -->
            <div class="col-md-3 text-center">
                <div class="card">
                    <div class="card-body">
                        <i class="fas fa-truck fa-3x mb-3"></i> <!-- Ícono para Egresos de mercancía -->
                        <h5 class="card-title">EGRESOS</h5>
                        <p class="card-text">Egresos de picos .</p>
                        <a href="#" class="btn btn-primary">Ir a Egresos</a>
                    </div>
                </div>
            </div>
            <!-- Card Saldos -->
            <div class="col-md-3 text-center">
                <div class="card">
                    <div class="card-body">
                        <i class="fas fa-archive fa-3x mb-3"></i> <!-- Ícono para Saldos de mercancía -->
